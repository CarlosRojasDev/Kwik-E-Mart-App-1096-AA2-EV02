...
export default function DetalleTipo({ info }) {
  const { id } = useParams();
  ...
  return (
    <div className="container mt-3">
      <div className="col-6 bg-opc p-4">
        <h2 className="mb-3 text-white">Detalle de tipo producto</h2>
        {message && (
          <CustomAlert
            message={message}
        ...
        <div key={data.id}>
          ...
          <div className="d-flex mb-3">
            ...
            <span className="form-control">{data.tipo}</span>
          </div>
          <div className="d-flex justify-content-between">
            <a href="../tipos" className="link">
              Volver
            </a>
            <button
              type="button"
